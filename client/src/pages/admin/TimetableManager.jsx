...
const TimetableManager = () => {
  ...
  const handleMarkAbsent = async (facultyId) => {
    if (
      !confirm(
        "Are you sure you want to mark this faculty as absent? This will affect all their classes for today.",
      )
    )
      return;
    try {
  ...
  const renderStatusSection = () => {
    ...
    if (getDayName(selectedDate) !== selectedCell.day.toUpperCase())
      return null;

    const isAbsent = absences.some(
      (a) =>
        a.facultyId === entry.facultyId &&
        (a.period === 0 || a.period === selectedCell.period),
    );
      ...
      <div className="mt-10 pt-10 border-t-2 border-dashed border-gray-100 animate-fadeIn">
        <div className="flex items-center justify-between mb-8 group">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-lg font-black text-[#003B73] tracking-tight uppercase leading-none">
                Intelligence Engine
              </h4>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">
                Substitution & Faculty Availability
              </p>
            </div>
          </div>
        </div>
          ...
          {isAbsent && (
            <div className="space-y-6 animate-fadeIn">
              <div className="p-6 bg-[#003B73]/5 rounded-[32px] border border-[#003B73]/10">
                <label className="block text-[10px] font-black text-[#003B73] uppercase tracking-widest mb-4 px-1">
              ...
              <div className="p-8 bg-amber-50 rounded-[40px] border-2 border-amber-200 shadow-xl shadow-amber-900/5 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h5 className="font-black text-amber-900 uppercase tracking-widest text-sm">
  ...
  return (
    <div className="flex flex-col animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6 px-2">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-1">
            Design academic schedules and manage daily faculty substitutions.
          </p>
        </div>
        <div className="flex items-center gap-4">
            ...
            >
              <RefreshCw
                ...
                className={
                  statusLoading
                    ? "animate-spin"
                    : "hover:rotate-180 transition-transform duration-700"
                }
              />
            </button>
          </div>
      ...
      <div className="bg-white p-10 rounded-[40px] shadow-xl border border-gray-100 min-h-[600px] transition-all relative group/grid">
        {/* Decorative Elements */}
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-gray-400 font-bold text-xs uppercase tracking-widest mt-1">
                ...
                {semester ? `Semester ${semester} ` : "Cycle Unset"}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gray-50/30 rounded-3xl border border-gray-100 relative z-10">
            <table className="w-full text-center border-collapse">
              <thead className="bg-gray-100/50 text-[#003B73] text-[10px] font-black uppercase tracking-[0.2em]">
                <tr>
                  <th className="px-8 py-8 text-left border-r border-gray-200/50 bg-gray-100/30 w-40">
                    Timeline
                  </th>
                  {periods.map((p) => (
                    <th
                      key={p.id}
                      className="px-6 py-8 border-b border-gray-100 min-w-[180px]"
                    >
              ...
              <tbody className="divide-y divide-gray-100">
                {days.map((day, dayIdx) => {
                  ...
                  return (
                    <tr
                      key={day}
                      className="group/row hover:bg-white transition-colors"
                    >
                      ...
                      {periods.map((p) => {
                        ...
                        const isAbsent =
                          ...
                          absences.some(
                            (a) =>
                              a.facultyId === entry.facultyId &&
                              (a.period === 0 || a.period === p.id),
                          );
                        const subEntry =
                          entry &&
                          substitutions.find((s) => s.timetableId === entry.id);
                        ...
                        return (
                          ...
                          >
                            {entry ? (
                              <div
                                className={`p-4 rounded-[24px] min-h-[140px] flex flex-col justify-between transition-all duration-500 shadow-sm border-2 ${subEntry
                              ...
                              >
                                <div>
                                  ...
                                  <div className="flex items-center gap-1.5 mt-1">
                                    <div
                                      className={`p-0.5 rounded-md ${subEntry ? "bg-amber-200/50" : "bg-gray-100"}`}
                                    >
                                      <User
                                        size={10}
                                        className={
                                    ...
                                    <span
                                      className={`text-[10px] font-bold truncate ${subEntry ? "text-amber-700 underline decoration-amber-300 decoration-2 underline-offset-2" : isToday && isAbsent ? "text-red-500 line-through" : "text-gray-500"}`}
                                    >
                                      {subEntry
                                        ? subEntry.substituteFaculty?.fullName
                                ...
                                <div className="flex items-center justify-between pt-2 mt-2 border-t border-gray-100/50">
                                  <div className="flex items-center gap-1.5 overflow-hidden">
                                    ...
                                    />
                                    <span className="text-[9px] font-black text-gray-400 truncate uppercase tracking-tighter">
                                      {entry.room || "L-BLOCK"}
                                    </span>
                                  </div>
                                  {colspan > 1 && (
                                    <div className="flex items-center gap-1.5 bg-[#003B73]/5 px-2 py-0.5 rounded-md">
                                      ...
                                      />
                                      <span className="text-[9px] font-black text-[#003B73]">
                                        P{p.id}-{p.id + colspan - 1}
                                      </span>
                                    </div>
                                  )}
                                </div>
                              ...
                              <div className="h-[140px] rounded-[24px] border-2 border-dashed border-gray-100 hover:border-[#003B73]/30 hover:bg-gray-50 transition-all flex flex-col items-center justify-center group/empty overflow-hidden relative">
                                ...
                                <span className="text-[9px] font-black text-gray-300 uppercase tracking-[0.2em] mt-3 opacity-0 group-hover/empty:opacity-100 transition-opacity">
                                  Assign Class
                                </span>
                              </div>
                            )}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-3xl font-black text-[#003B73] tracking-tight lowercase">
                      Assigning Class <span className="text-gray-300">/</span>{" "}
                      {selectedCell?.day}
                    </h3>
                    <p className="text-gray-400 font-bold text-xs uppercase tracking-widest mt-1">
